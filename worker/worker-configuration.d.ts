/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 458e06490af4987e7ef03c3dd48a2d91)
// Runtime types generated with workerd@1.20260611.1 2026-06-08 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	...
	POSTHOG_HOST: string;
	ENVIRONMENT: string;
	OrderAgent: DurableObjectNamespace<import("./src/index").OrderAgent>;
	ShopAgent: DurableObjectNamespace<import("./src/index").ShopAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OrderAgent" | "ShopAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANTHROPIC_API_KEY" | "WHATSAPP_VERIFY_TOKEN" | "WHATSAPP_APP_SECRET" | "WHATSAPP_ACCESS_TOKEN" | "WHATSAPP_API_VERSION" | "ADMIN_TOKEN" | "DATABASE_URL" | "DATABASE_URL_ADMIN" | "STOREFRONT_URL" | "R2_PUBLIC_BASE_URL" | "NEON_AUTH_BASE_URL" | "NEON_AUTH_JWKS_URL" | "POSTHOG_KEY" | "POSTHOG_HOST" | "ENVIRONMENT">> {}
}
